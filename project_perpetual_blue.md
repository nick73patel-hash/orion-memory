...
- **Crew:** Captain **Sean Powell** (South African) — mobile **+1 954 807 1333** (US/Fort Lauderdale number), `captainsean@perpetualbluebvi.com`. ⚠️ **Chef Elise McNabb departed 2026-08-29.** A replacement chef has been **identified as of 2026-08-29 — name, nationality and start date still to be captured.** Nationality drives the BVI work-permit path and lead time; permits are **person-specific**, so Elise's in-process application cannot be transferred and needs withdrawing. (Her past records stay: the $108.97 SJU→EIS flight on 2026-07-28 is a real historical expense.)
