...
- [ ] **Create Sean's CRM login** — add a Supabase Auth user for **`captainsean@perpetualbluebvi.com`** (captain), then link with `UPDATE crm_users SET supabase_uid = '<uuid>' WHERE email = 'captainsean@perpetualbluebvi.com';`
