...
- ⭐ **OWNERSHIP IS FIXED AT ONE THIRD EACH, REGARDLESS OF CAPITAL CONTRIBUTED (confirmed 2026-08-30).** This is the decision that defines what the capital module is *for*.
  ...
  - This is why `instrument` (equity vs member loan) is typed **NOT NULL with no default** in the capital design — an over-contribution booked as plain capital sits in the accounts forever with nothing recording whether it ever comes back. ⚠️ **Ask the accountant** whether the excess above a one-third share should be booked as a member loan rather than capital.
