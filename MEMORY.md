...
| | *DU: Buy fixer-uppers near University of Denver, rent by room. LCCC: Rental arbitrage near Laramie County CC, Cheyenne WY — validate before acquiring. No WY state income tax.* | | | |
| 13 | Taste of Denmark — Bulk Bakery & Distribution | 🟡 Starting | Ronnie | [project_taste_of_denmark.md](project_taste_of_denmark.md) |
...
- **"Add to Orion's consciousness"** — add new values/principles to session log
- **When asked to update the session log** — update log + git commit + git push
- Buddhist principles matter — mindfulness, non-harm, long-term thinking over short-term wins
- People first (guests, employees, vendors) — profit is an outcome, not the only goal
- Vision: use Claude Code to set up all businesses cheaply, efficiently, and with smart systems
